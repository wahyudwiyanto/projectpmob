...
public final class ActivityTahanpapanfemaleBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTahanpapanfemaleBinding(@NonNull LinearLayout rootView, @NonNull Button button21,
  ...
  @NonNull
  public static ActivityTahanpapanfemaleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTahanpapanfemaleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tahanpapanfemale, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTahanpapanfemaleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTahanpapanfemaleBinding((LinearLayout) rootView, button21, button22,
          button23, button24, button25, imageView9, main);
    }
